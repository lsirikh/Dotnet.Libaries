...
namespace Ironwall.Dotnet.Framework.Models.Communications
{
    public static class ResponseFactory
    {
        ...
        /// <param name="sessionTimeOut">Account Session DataTime Span</param>
        /// <param name="details">IUserModel</param>
        /// <param name="createdTime">Session Created DataTime</param>
        /// <param name="expiredTime">Expected Session Expiration DataTime</param>
        /// <returns></returns>
        public static T Build<T>(
            string userId,
            string token,
        ...
        /// <param name="success">bool</param>
        /// <param name="msg">string</param>
        /// <param name="expiredTime">string for Expiration DataTime</param>
        /// <returns></returns>
